<a href="https://slobodaapl.dev">
  <picture>
    ...
    <img src="./assets/hero-light.svg" alt="Tibor Sloboda. AI research and systems engineering. You can call me Jack. Visit slobodaapl.dev." width="1200">
  </picture>
</a>
...
<picture>
  ...
  <img src="./assets/section-light.svg" alt="Selected work" width="1200">
</picture>
...
<p align="center">
  <a href="https://github.com/slobodaapl/hiway">
    <picture>
      ...
      <img src="./assets/hiway-light.svg" alt="hiway: typed events, scoped authority, bounded storage, and backpressure. Supports no_std and no_alloc. Open the repository." width="372">
    </picture>
  </a>
  <a href="https://github.com/aleph0-ai/shapeflow">
    <picture>
      ...
      <img src="./assets/shapeflow-light.svg" alt="ShapeFlow: deterministic multimodal dataset generation from a shared latent scene, with aligned modalities. Rust core and Python bindings. Open the repository." width="372">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="https://github.com/slobodaapl/onesweep-radix-sort">
    <picture>
      ...
      <img src="./assets/onesweep-radix-sort-light.svg" alt="onesweep-radix-sort: GPU radix sorting for unsigned 32-bit keys, optional values, and independent contiguous segments. HLSL, GLSL, and Slang shaders. Open the repository." width="372">
    </picture>
  </a>
  <a href="https://github.com/slobodaapl/dotfilers">
    <picture>
      ...
      <img src="./assets/dotfilers-light.svg" alt="dotfilers: a Rust CLI for Git-backed dotfile management. Track configuration files, replace them with symlinks, and restore them. Open the repository." width="372">
    </picture>
  </a>
</p>

<details>
  <summary><sub>🔥 The campfire is still here.</sub></summary>

  Medicine, physics, mathematics, sci-fi, board games, TTRPGs, and video games. Still curious about far too many things.

  <sub>Stay awhile, and rest your weary mind.</sub>
</details>
